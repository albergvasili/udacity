...
class NearEarthObject:
    ...
    def __init__(self, designation=None, name=None, diameter=float('nan'),
                 hazardous=False):
    ...
    def __str__(self):
        ...
        if self.hazardous:
            ...
            hazard = 'is not'
        return (f'NEO {self.fullname} has a diameter of {self.diameter} km'
                ' and ' + hazard + ' potentially hazardous.')
...
class CloseApproach:
    ...
    def __init__(self, designation=None, time=None, distance=0.0,
                 velocity=0.0):
